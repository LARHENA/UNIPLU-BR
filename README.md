...
<br>•	Structural and Nominal Standardization: Harmonization of column names, attributes, and storage formats, addressing historical changes in data protocols and formats within the same agency. 
<br>•	Time Zone Adjustment: Standardization of timestamps based on the station's geographical location (UTC offset).
<br>• Temporal Resolution: Records ranging from 10-minute intervals to 1-day resolution.
...
<p align="left">
  <img src="https://github.com/LARHENA/UNIPLU-BR/blob/main/img/Imagem1.jpeg?raw=true" alt="Spatial distribution of the rainfall gauge stations in Brazil across different data sources" width="650">
  <img src="https://github.com/LARHENA/UNIPLU-BR/blob/main/img/Imagem2.jpeg?raw=true" alt="Temporal evolution of the number of available rainfall stations in Brazil from 1855 to 2025: (Top) stations with daily resolution; (Bottom) stations with sub-daily resolution." width="650">
</p>
